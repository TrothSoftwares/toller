...
/*********  START OF CODE FOR INCLUDING TIMEPICKER IN FRONTEND *************/
wp_register_style('kv_js_time_style' , get_template_directory_uri(). '/css/jquery.timepicker.css');
wp_enqueue_style('kv_js_time_style');
function load_timepicker_script(){
    wp_register_script(
        'time-picker',
        get_template_directory_uri(). '/js/jquery.timepicker.js',
        array( 'jquery' )
    );
    wp_enqueue_script( 'time-picker' );
}
add_action('wp_enqueue_scripts', 'load_timepicker_script');
// wp_enqueue_script('time-picker',get_template_directory_uri(). '/js/jquery.timepicker.js');
/*********  END OF CODE FOR INCLUDING TIMEPICKER IN FRONTEND *************/




/****************   START OF CODE FOR RESTRICTING AUDIO FILES TO MP3 *************/
